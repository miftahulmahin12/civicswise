...
const sheetVariants = cva(
  "fixed z-50 gap-4 glass-surface-modal !rounded-none p-6 transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
